...
- Die **Grundlagen von Netzwerken** (LAN/WLAN) erklären.
- Das **OSI-Referenzmodell** und seine Schichten beschreiben.
- **Netzwerktopologien** (Stern, Bus, Ring, Mesh) und deren Vor-/Nachteile benennen.
- **Anforderungen an Netzwerke** (Bandbreite, Sicherheit, Skalierbarkeit) analysieren.
